...
public class UpgradeableTridentRenderer extends EntityRenderer<UpgradeableTridentEntity> {
    public static final Identifier TEXTURE = Identifier.of(Netherinth.MOD_ID, "textures/entity/custom_trident.png");
    private final TridentEntityModel model;

    public UpgradeableTridentRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.model = new TridentEntityModel(context.getPart(EntityModelLayers.TRIDENT));
    }

    @Override
    public void render(UpgradeableTridentEntity tridentEntity, float f, float g, MatrixStack matrixStack,
    ...
    @Override
    public Identifier getTexture(UpgradeableTridentEntity tridentEntity) {
        return TEXTURE;
    }
}